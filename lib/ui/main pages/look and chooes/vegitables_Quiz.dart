...
class VegitablesQuiz extends StatefulWidget{
  @override
  State<VegitablesQuiz> createState() => _VegitablesQuizState();
}
List<Numbermodel> vegitablelist =vegitable1();
class _VegitablesQuizState extends State<VegitablesQuiz> {

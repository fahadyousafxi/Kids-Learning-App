...
import '../sounds/ColorSound.dart';


class LearningColor extends StatefulWidget{
  int? index ;
  LearningColor();
  @override
  State<LearningColor> createState() => _LearningColorState();
}
final FlutterTts flutterTts = FlutterTts();
class _LearningColorState extends State<LearningColor> {
                          ...
                          child: Card(
                            ...
                            child:  Column(
                                ...
                                children: [
                                  ...
                                  Text(colorlist[index].Text!, style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),)
                                ]
                            ),
                          )
                      );

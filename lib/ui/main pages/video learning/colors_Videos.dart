...
class ColorsVideos extends StatefulWidget{
  @override
  State<ColorsVideos> createState() => _ColorsVideosState();
}
List<Numbermodel> colorvideolist = colorvideo1();
List<String> colorvideoURLlist = colorvideoURL();

class _ColorsVideosState extends State<ColorsVideos> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Colors Video Songs',style: TextStyle( color: Colors.black,fontFamily: "arlrdbd"),),
      ),

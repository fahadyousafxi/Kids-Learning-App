...
class AnimalsVideos extends StatefulWidget{
  @override
  State<AnimalsVideos> createState() => _AnimalsVideosState();
}
List<Numbermodel> animalvideolist = animalvideo1();
List<String> animalvideoURLlist = animalvideoURL();
class _AnimalsVideosState extends State<AnimalsVideos> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Animal Video Songs',style: TextStyle( color: Colors.black,fontFamily: "arlrdbd"),),
      ),
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Center(child: Text(animalvideolist[index].Text!,style: TextStyle(color: Colors.black,fontFamily: "arlrdbd",fontSize: 15),)),
                            )
                          ]
                      ),
                    ),

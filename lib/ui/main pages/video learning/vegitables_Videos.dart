...
class VegitablesVideos extends StatefulWidget{

  @override
  State<VegitablesVideos> createState() => _VegitablesVideosState();
}
List<Numbermodel> vegitablevideolist = vegitablevideo1();
List<String> vegitablevideoURLlist = vegitablevideoURL();

class _VegitablesVideosState extends State<VegitablesVideos> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('Vegitable Video Songs',style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),),
      ),

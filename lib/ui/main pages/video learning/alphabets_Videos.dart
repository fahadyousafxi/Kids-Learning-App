...
class AlphabetsVideos extends StatefulWidget{

  @override
  State<AlphabetsVideos> createState() => _AlphabetsVideosState();
}
List<Numbermodel> alphabetvideolist = alphabetvideo1();
List<String> alphabetvideoURLlist = alphabetvideoURL();

class _AlphabetsVideosState extends State<AlphabetsVideos> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text('ABC Video Songs',style: TextStyle(color: Colors.black,fontFamily: "arlrdbd"),),
      ),

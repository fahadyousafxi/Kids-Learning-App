...
class GuessColors extends StatefulWidget{

  @override
  State<GuessColors> createState() => _GuessColorsState();
}
List<Numbermodel> colorlist =COLOR1();
class _GuessColorsState extends State<GuessColors> {
                            ...
                            Column(
                                ...
                                children: [
                                  ...
                                  Center(
                                      child: ListTile(
                                        trailing: InkWell(
                                          onTap:  isPressed ? index + 1== colorlist.length
                                              ?(){

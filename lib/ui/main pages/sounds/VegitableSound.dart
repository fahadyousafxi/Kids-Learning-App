                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return Center(
                                    child: Column(
                                      ...
                                      children: [
                                        Container(height: 1,),
                                        Image.asset(vegitablelist[widget.index].image!, alignment: Alignment.topCenter,),

                                        Text(vegitablelist[widget.index].Text.toString(), style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                                        Container(height: 1,),
                                      ],
                                    ),
                                  );

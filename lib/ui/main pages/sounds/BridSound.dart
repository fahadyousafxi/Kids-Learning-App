                              ...
                              itemBuilder: (BuildContext context, int index1) {
                                return Center(
                                  child: Column(
                                    ...
                                    children: [
                                      Container(height: 1,),
                                      Image.asset(bridslist[widget.index1].image!,alignment: Alignment.topCenter,),

                                      Text(bridslist[widget.index1].Text.toString(), style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                                      Container(height: 1,),
                                    ],
                                  ),

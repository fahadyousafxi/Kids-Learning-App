                                  ...
                                  return Center(
                                    child: Column(
                                      ...
                                      children: [
                                        Container(height: 1,),
                                        Image.asset(
                                          FRUITlist[widget.index].image!, alignment: Alignment.topCenter,height: 280,),
                                        Text(FRUITlist[widget.index].Text.toString(), style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                                        Container(height: 1,),
                                      ],
                                    ),
                                  );
